    ...
    <div className="w-screen">
      <div className="relative flex items-center justify-between w-[75vw] lg:w-[60vw] mx-auto py-5">
        ...
        <div className="hidden md:flex items-center justify-between space-x-4 h-full">
          <Link to="/signup">
            <button className="border-[1px] border-gray-500 text-white font-bold bg-gray-500 px-2 py-1 rounded hover:bg-white hover:text-gray-700">
              Sign-up
            </button>
          </Link>
        ...
        <div
          id="menu"
          className="absolute space-x-5 text-white shadow-xl md:hidden right-0 top-[80%] bg-gray-500 p-3 rounded"
        >
          <Link to={!user && "/login"}>
